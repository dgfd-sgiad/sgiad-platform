...
P = [
 ...
 ("Projet de Formation Professionnelle et d'Entrepreneuriat pour l'Emploi (FP2E)","Enseignement et formation professionnelle","Projet",300,"2022-05-27",44.00,"2027-03-31",[(["fp2e"],[])]),
 ("PACOFIDE","Agriculture","Projet",310,"2020-10-22",59.31,"2030-04-30",[(["pacofide"],["2024"])]),
 ("Projet d'Augmentation de l'Accès à l'Energie (P2AE)","Énergie","Projet",200,"2021-11-23",55.60,"2026-12-31",[(["p2ae"],[])]),
 ...
 ("Projet Forêts Classées Bénin 1 (PFC1)","Environnement","Projet",90.1,"2019-10-01",93.20,"2026-11-30",[(["pfc1"],[])]),
 ("Projet Forêts Classées Bénin 2 (PFC2)","Environnement","Projet",80.7,"2025-09-09",2.95,"2032-07-31",[(["pfc2"],[])]),
 ("PMUD-GN","Cadre de vie","Projet",200,"2025-12-18",11.62,"2030-12-31",[(["pmud"],[]),(["mobilite urbaine"],[])]),
 ("Programme multi-phases Economie Bleue et Résilience des Zones côtières (WACA+)","Environnement","Projet",147,None,None,"2031-11-26",[]),
...
if not APPLY: print("👉 Si conforme, lance : python import_bm_projets2.py apply")
